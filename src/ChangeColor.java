 ...
 * the color changes (e.g. the starting color of the shape and the color it was changed to) and
 * when these changes occur in the animation. The constructor calls the super class,
 * AbstractTransform, to instantiate the the shape's unique identifier and the start/end time
 * of the transformation. The constructor also instantiates the original Color values (fromR,
 * fromG, fromB) and the new Color values (toR, toG, toB) that the should transform the object.
 */
