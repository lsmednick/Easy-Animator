...
//  }
  ...
  public void testChangeColor1() {
    ...
    assertEquals("Shapes:\n"
            ...
            + "Shape Ian McKellen changes color from (4,178,100) to (100,178,200) from t=2 to t=10\n"
...
//  }
  ...
  public void testChangeScale1() {
    ...
    assertEquals("Shapes:\n"
            ...
            + "Min corner: (10, 3), Width: 7, Height: 6, Color: (70, 250, 18)\n"
            + "\n"
            + "Shape Ian McKellen scales from Width: 7, Height: 3 to Width: 10, Height: 6 from t=2 to t=5\n"
            + "Shape Rebel Wilson scales from Width: 10, Height: 10 to Width: 8, Height: 2 from t=2 to t=20\n"
            + "Shape Idris Elba scales from Width: 7, Height: 6 to Width: 3, Height: 2 from t=9 to t=12\n", testModel.getState());
  }
...
//  }
  ...
  public void testMultiple() {
    ...
    assertEquals("Shapes:\n"
                    ...
                    + "Shape Judi Dench scales from Width: 7, Height: 3 to Width: 10, Height: 15 from t=2 to t=4\n"
                    + "Shape Jason Derulo scales from Width: 10, Height: 10 to Width: 20, Height: 10 from t=2 to t=8\n"
